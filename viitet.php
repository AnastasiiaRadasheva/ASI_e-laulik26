...
<main class="container home-page">
  ...
  <h1>Viited ja kasutatud allikad</h1>

  <p class="muted" style="text-align:center; margin-bottom:20px;">
    Allpool on loetletud veebiallikad, mida rakendus kasutab Eesti kultuuri- ja uudisteinfo kogumiseks.
  </p>
