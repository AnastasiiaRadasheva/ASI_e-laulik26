...
function g1Pick(choiceIndex, clickedBtn) {
  ...
  buttons.forEach((b, i) => {
    if (i === q.c) b.classList.add("btn-correct");
  });
...
(function initWordleET() {
  ...
  const WORDS = [
    "TARTU","NARVA","PÄRNU","KEILA","RAPLA","VALGA","PAIDE","JÕHVI","TÕRVA","LOKSA",
    "KEHRA","PÜSSI","KUNDA","SINDI","PÕLVA","PÜHAD","MÕISA","KUNST","OOPER","KADRI",
    "MARDI","TANTS","LAULU","VORST","REGIL","SAUNA","PRAED","KIRIK","JUUST","RUKIS",
    "PÕDER","KÄBID","RABAD","SOODE","KALDA","RANDA","ILVES","JÄNES",
  "KÕRVA","PÕLLU","SÕBER","PÕHJA","TÄNAV","ÕUNAD","ÕIGUS","KÄRBS","KÄSIK","KÄRBI",
  "MÄGED","MÄRJA","MÕTTU","MÕTTE","SÜGIS","SÜDAS","SÜÜTU","ÖÖSEL","ÄÄRES","ÄMBER",
  "PUHKA","KODUS","LINNU","RANDU","SAADE","SAATE","KELLE","KÕIGE","KORDA","HOMME",
  "TÄHTI","TÖÖLE","TÖÖTA","PESEN","PESKU","VÄIKE","SUURE","KÜLMA","KÜLAL","KÜLGE",
  "PILVE","ILMAA","ILMAD","VEELE","VETTA","JÕUSA","JÕULU","JÕUDU","KÕRGE","KÕVER",
  "PÕSSE","SÕJAD","SÕIDA","SÕITU","SÕIME","SÕNAS","SÕNAD","ÕHTUL","ÕHUMA","ÕMBLE",
  "LÕUNA","LÕHNA","LÕBUS","MÕNUS","TÄNAH","TÕEST","TÕNIS","VÕTAN","VÕTAK","VÕIME",
  "VÕIDA","VÕIST","VÕRRE","VÕRKU","KÄIVE","KÄIMA","KÄITU","KÄÄRU","KÄÄRT","KÜBAR",
  "KÜPSE","KÜÜNE","KÜLVI","KÜLMA","ÕHUKE","ÕIGET","ÕIGEL","ÕNNEK","ÕNNEL","ÕNDED",
  "RÄSTA","RÄIME","RÖÖVI","RÖÖVL","PÄIKE","PÄEVÄ","PÄEVA","ÖÖBID","ÖÖMAI","ÖÖUNI"
  ];
