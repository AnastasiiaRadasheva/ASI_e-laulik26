...
/**
 * ✅ Ühele maakonnale võib määrata mitu RSS-i (linkide massiiv)
 */
$RSS_BY_COUNTY = [
  'north_pink' => [
    'https://rss.app/feeds/gYHyLQRc7ccySC0Q.xml',
    // 'https://another-source.example/rss.xml',
  ],
  'east_red' => [
     'https://rss.app/feeds/GrpIraee0y8oNtZM.xml',
  ],
  'south_green' => [
  ...
  'center_blue' => [
   'https://rss.app/feeds/qui8LQhaRk2Br3sD.xml',
  ],
];
...
$LIMIT_PER_FEED = 4;                  // ✅ 5–7 uudist (panin 7)
$PLACEHOLDER_IMG = 'placeholder.jpg'; // ✅ pane fail samasse kausta või kasuta URL-i
